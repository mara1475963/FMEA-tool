export const getPFMEADetection = (handler, element) => {
  return (
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            gauging (attribute or variable) that should detect the failure mode
            or failure cause.
          </td>
        ...
        <tr>
          ...
          <td>
            ...
            such as coordinate measuring machine that should detect failure mode
            or failure cause.
          </td>
          <td>
            <textarea
        ...
        <tr>
          ...
          <td>
            Human inspection (visual, tactile, audible), or use of manual
            gauging (attribute or variable) that will detect the failure mode or
            failure cause.
          </td>
        ...
        <tr>
          ...
          <td>
            Machine-based detection (automated or semi-automated with
            notification by light, buzzer, etc.) or use of inspection equipment
            such as coordinate measuring machine that will detect failure mode
            or failure cause.
          </td>
          <td>
            <textarea
        ...
        <tr>
          ...
          <td rowSpan={2}>
            ...
            experience with method, gauge R&R results are acceptable on
        ...
        <tr>
          ...
          <td>
            ...
            in-station, prevent further processing, or system will identify the
            product as discrepant and allow it automatically move forward in the
            process until the designated reject unload area. Discrepant products
            will be controlled by a robust system that will prevent the outflow
            of the product from the facility.
          </td>
          <td>
            <textarea
              id="w3review"
