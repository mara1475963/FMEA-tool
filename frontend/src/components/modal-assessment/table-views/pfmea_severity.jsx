export const getPFMEASeverity = (handler, handler2, element, data) => {
  return (
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              User) other than for regulatory noncompliance) Failure may result
          ...
          <tr>
            ...
            <td>
              A portion of the production run may have to be reworked and
              accepted
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              100% of production run may have to be reworked in station before
              it is processed
            </td>
            <td>
